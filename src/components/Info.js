...
<p className='text-zinc-400'>Swiggy Genie</p>
    ...
    <div className='w-full bg-yellow-400 p-3 text-xl absolute flex justify-center font-semibold'>
      <h1>
        created by <Link to={"https://github.com/Geethuc"}><span className='text-slate-950'>@ Geethu Subramanyan C </span></Link>
      </h1>
